...
check("singular CHORUS marker recognized", P.is_chord_or_marker_line("CHORUS") is True)
check("singular REFRAIN marker recognized", P.is_chord_or_marker_line("REFRAIN") is True)
check("singular BRIDGE marker recognized", P.is_chord_or_marker_line("BRIDGE") is True)
check("singular INTRO marker recognized", P.is_chord_or_marker_line("INTRO") is True)
check("singular END marker recognized", P.is_chord_or_marker_line("END") is True)
check("singular REPEAT marker recognized", P.is_chord_or_marker_line("REPEAT") is True)
...
check("lowercase marker recognized", P.is_chord_or_marker_line("chorus") is True)
...
check("chord token sus4 detected", P._is_chord_token("Gsus4") is True)
check("chord token add9 detected", P._is_chord_token("Cadd9") is True)
check("chord token slash bass digit detected", P._is_chord_token("C/5") is True)
check("chord token b5 detected", P._is_chord_token("F#m7b5") is True)
